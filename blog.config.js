...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '百度AI产品经理', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.goodxu.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, AI, LLM', // 网站关键词 英文逗号隔开
