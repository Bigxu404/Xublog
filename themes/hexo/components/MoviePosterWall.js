        ...
        <div className='mb-5 md:mb-8'>
          <div className='flex flex-col gap-3 md:flex-row md:items-center md:gap-5'>
            ...
            <button
              ...
              className='h-[85px] shrink-0 rounded-lg border border-gray-200 px-3 text-[11px] leading-none text-gray-600 transition-colors hover:border-gray-400 hover:text-gray-900 dark:border-gray-700 dark:text-gray-300 dark:hover:border-gray-500 dark:hover:text-white'>
              重置筛选
            </button>
          </div>
        </div>
  ...
  return (
    <label className='flex min-w-0 flex-1 items-center gap-2'>
      ...
      <select
        ...
        className='h-[85px] min-w-0 flex-1 rounded-lg border border-gray-200 bg-transparent px-2 text-[11px] leading-none text-gray-700 outline-none transition-colors focus:border-gray-400 dark:border-gray-700 dark:text-gray-200 dark:focus:border-gray-500'>
