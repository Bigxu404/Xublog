...
function getRawNotion() {
  if (!globalStore.notion) {
    globalStore.notion = new NotionLibrary({
      ...
      // notion-client@7 已从 kyOptions 切换为 ofetchOptions；无 UA 时 Cloudflare 常返回 403
      ofetchOptions: {
        headers: {
          'user-agent':
            'Mozilla/5.0 (compatible; NotionNext/4.10.5; +https://github.com/notionnext-org/NotionNext)',
          'notion-client-version': '23.13.0.1984'
        },
        hooks: {
          beforeRequest: [
            request => {
